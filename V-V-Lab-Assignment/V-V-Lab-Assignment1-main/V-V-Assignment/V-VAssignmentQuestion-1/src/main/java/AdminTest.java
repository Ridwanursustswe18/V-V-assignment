...
{
   Admin ad=new Admin();
   assertEquals(true,ad.addProducts("Corolla","Vehicle","Car",1,100000));
}
    @Test
    ...
    {
        Admin ad=new Admin();
        ad.addProducts("Corolla","Vehicle","Car",10,100000);
    ...
    void testModifyProducts()
    {
        ...
        ad.addProducts("Corolla","Vehicle","Car",2,100000);
        ad.addProducts("Corolla","Vehicle","Car",4,100000);
        ad.addProducts("Corolla","Vehicle","Car",1,100000);
       ad.modifyProducts(4,"Corolla","Vehicle","ModelCars");
    ...
    void testModifyProducts1()
    {
        ...
        assertEquals(true,  ad.modifyProducts(100,"Corolla","Vehicle","ModelCars"));
    }
}